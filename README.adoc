...
== Stage 5: Preparing CICD Infrastructure for Kitchensink using ArgoCD
...
== Stage 6: Launch Kitchensink on JBOSS EAP 7.2 with ArgoCD using helm + kustomize to deploy in two overlays
